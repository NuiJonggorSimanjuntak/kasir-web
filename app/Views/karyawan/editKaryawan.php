...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 col-6">
        <div class="card-body">
            <form action="<?= base_url('ubahKaryawan/' . $data['id']) ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="mb-3">
                    <label for="email" class="form-label"><b>Email :</b></label>
                    <input type="text" class="form-control <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" id="email" name="email" placeholder="Masukkan Email" value="<?= old('email', $data['email']); ?>" autofocus>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" id="username" name="username" placeholder="Masukkan Username" value="<?= old('username', $data['username']); ?>">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?php if (session('errors.nama_lengkap')) : ?>is-invalid<?php endif ?>" id="nama_lengkap" name="nama_lengkap" placeholder="Masukkan Nama Lengkap" value="<?= old('nama_lengkap', $data['nama_lengkap']); ?>">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control <?php if (session('errors.no_hp')) : ?>is-invalid<?php endif ?>"
                            ...
                            value="<?= old('no_hp', substr($data['no_hp'], 3)); ?>"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control <?php if (session('errors.tanggal_lahir')) : ?>is-invalid<?php endif ?>" id="tanggal_lahir" name="tanggal_lahir" value="<?= old('tanggal_lahir', $data['tanggal_lahir']); ?>">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?php if (session('errors.pendidikan_terakhir')) : ?>is-invalid<?php endif ?>" id="pendidikan_terakhir" name="pendidikan_terakhir" placeholder="Masukkan Pendidikan Terakhir" value="<?= old('pendidikan_terakhir', $data['pendidikan_terakhir']); ?>">
                    <div class="invalid-feedback">
