...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 col-4">
        <div class="card-body">
            <form action="<?= base_url('ubahMenu/' . $menu['id']) ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?php if (session('errors.description')) : ?>is-invalid<?php endif ?>" id="description" name="description" placeholder="Masukkan Nama Menu" value="<?= old('description', $menu['description']); ?>" autofocus>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <div class="custom-control custom-switch custom-switch-on-success custom-switch-off-danger">
                        <input type="checkbox"
                            ...
                            name="active"
                            value="1"
                            <?= old('active', $menu['status']) == '1' ? 'checked' : '' ?>>
